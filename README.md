...
[![npm version](https://badge.fury.io/js/%40renchris%2Freplicache-react.svg)](https://www.npmjs.com/package/@renchris/replicache-react)

<br />
  <pre>npm i <a href="https://www.npmjs.com/package/@renchris/replicache-react">@renchris/replicache-react</a></pre>
  <br />
...
React 19+ fork. React 19 has automatic batching for all updates (including microtasks), so `unstable_batchedUpdates` has been removed. Published as `@renchris/replicache-react`. Requires React 19+.
